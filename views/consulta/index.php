...
<body>
    ...
    <b style="text-align: center;">
        <h1 >Informacion sobre las tiendas en linea</h1>
    </b>
    ...
    <h3 style="text-align: justify;">
        ...
        <p>La tienda que eligen tiene servicio de entrega a domicilio, pueden incluso pagar en la plataforma vía tarjeta 
        de crédito o debido y esperar los productos en casa, agregó.
        “La funcionalidad de la app es que para ti como usuario no te cueste nada hacer esa comparación en tu laptop o en tu smartphone.
         Puedes hacer la comparación del producto o del carrito completo
         y nosotros te decimos cuál es el supermercado o la farmacia que más te conviene"</p>

         
        </h3>

         <p style="text-align: center;">
            <img src="C:\Users\HP\Documents/carrito.jpeg" alt="Super" style="width:250px;height:180px; border:0;">
            <img src="C:\Users\HP\Documents/dulceria.jpg" alt="Super" style="width:250px;height:180px; border:0;">
        </p>
<h3 style="text-align: justify;">
